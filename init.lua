...
vim.keymap.set('n', '<leader>fb', require('telescope.builtin').buffers, { desc = 'Search existing buffers' })
...
vim.keymap.set('n', '<leader>sx', require("telescope").extensions.live_grep_args.live_grep_args, { desc = '[S]earch by Grep (e[X]tended)' })
